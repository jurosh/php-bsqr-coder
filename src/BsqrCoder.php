...
namespace com\peterbodnar\bsqrcoder;
...
class BsqrCoder {
	...
	protected $base32;
	/** @var utils\ClientDataEncoder - BySquare serializer. */
	protected $cldEncoder;
	/** @var utils\ClientDataParser - BySquare parser. */
	protected $cldParser;
	/** @var utils\Lzma - Lzma compressor / decompressor. */
	protected $lzma;
	...
	public function __construct() {
		...
		$this->cldEncoder = new utils\ClientDataEncoder();
		$this->cldParser = new utils\ClientDataParser();
		$this->lzma = new utils\Lzma();
	}
	...
	public function parse($input) {
		...
		} catch (utils\ParserException $ex) {
